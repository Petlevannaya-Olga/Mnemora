    ...
    : IMaterialContentStore
{
        ...
        IReadOnlyDictionary<string, string> files = new Dictionary<string, string>
            {
                ...
                ["answer.md"] =
                    content.ReferenceAnswerMarkdown
            };
    ...
    private Result<string, Error>
        GetMaterialDirectoryPath(
            ...
            MaterialType materialType)
    {
        var storagePathResult =
            storagePathProvider.GetStoragePath();
        ...
        string typeDirectoryName =
            materialType switch
            {
                MaterialType.Article =>
                    ArticlesDirectoryName,

                MaterialType.Question =>
                    QuestionsDirectoryName,
